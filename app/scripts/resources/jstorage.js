 ...
 */
 ...
 (function(){
    ...
    var
        ...
        /* Actual browser storage (sessionStorage or globalStorage["domain"]) */
    ...
    function _init(){
        ...
        if(sessionStorageReallyWorks){
            ...
            } catch (E3) {/* Firefox fails when touching sessionStorage and cookies are disabled */ }
        }
        /* Check if browser supports globalStorage */
            ...
            } catch (E4) {/* Firefox fails when touching sessionStorageReallyWorks and cookies are disabled */ }
        }
    ...
    function _setupObserver(){
        if(_backend == "sessionStorage" || _backend == "globalStorage"){
            if("addEventListener" in window){
